...
public class JsonReader {
     ...
     */
    private Pair<String, Object> parseMapElement() throws Exception {
     ...
     */
    private Object parseValue(boolean goNext) throws Exception {
        if (goNext) {
            next();
        }
     ...
     * @return the map.
     */
    private Map<String, Object> parseMap() throws Exception {
     ...
     */
    private void check(char c, Object... objects) throws Exception {
        if (!is(c, objects)) {
            throw new Exception("Unexpected character '" + c + "' instead of '" + Arrays.toString(objects) + "' at line " + currentLine + "!");
        }
    }
    ...
    private boolean is(char c, Object... objects) {
        ...
        for (Object expected : objects) {
            if (expected instanceof char[] values) {
