...
@Command(name = "fgen", version = "1.0.0", description = "A tool to generate fractals based on various sets of parameters.\n" +
...
public class FGen extends Program {
    ...
    @Option(names = {"--load"}, description = "Loads a configuration stored at the specified <filepath>.", usage = "<filepath>")
